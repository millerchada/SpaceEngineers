// IO Production Manager v2.3.4 — warehouse sorting/balancing/organization,
...
// live under [IOPM.*]. v2.3.4: subtype-aware category overrides; Grain and
// Algae now route to Consumables instead of the generic PhysicalObject ->
// Tools category. See CHANGELOG.md for 2.2.0-2.3.3 history.
...
void BuildTypeCategoryMap()
{
    ...
    _subtypeCategoryOverride["Algae"] = "Consumables";
}
