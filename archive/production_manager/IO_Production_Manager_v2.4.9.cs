// IO Production Manager v2.4.9 - warehouse sorting, production planning, stall recovery,
...
// v2.4.9: the seeded loadout template lists EVERY item IOPM can resolve by name, deduped
// by real item type and grouped, so the player picks from a full menu.
const string VERSION = "2.4.9";
