// IO Production Manager v2.4.5 - warehouse sorting, production planning, stall recovery,
...
// v2.4.5: display only - compact k/M stock quantities, narrower value columns, and
// diagnostic keys always emitted (MyIni cannot remove a key once written).
