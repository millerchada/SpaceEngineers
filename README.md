...
```
IO_Production_Manager_v2.4.6.cs      deployed in-game (validated)
IO_Production_Manager_v2.4.7.cs      candidate - BlockedBy diagnostic fix
...
archive/production_manager/          v1.0.11 - v2.4.5
