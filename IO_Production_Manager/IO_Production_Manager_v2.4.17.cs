// IO Production Manager v2.4.17 - warehouse sorting, production planning, stall recovery,
...
// v2.4.17: LaserEmitter and Cryocooler recipes, closing the last two ingredient chains.
// Managed set 35 -> 37. No new ItemDefs needed; both output subtypes already dump-confirmed.
const string VERSION = "2.4.17";
