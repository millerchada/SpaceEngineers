// IO Production Manager v2.4.25 - warehouse sorting, production planning, stall recovery,
...
// v2.4.25: [Sorting] OrganizeSkip=<categories> exempts named warehouse categories from
// cosmetic slot ordering, so ore containers can stay unordered while everything else is tidy.
const string VERSION = "2.4.25";
