// IO Production Manager v2.4.23 - warehouse sorting, production planning, stall recovery,
...
// v2.4.23: category overrides match on FULL TypeId/SubtypeId, not SubtypeId alone - food
// Grain and seed Grain share a SubtypeId and were both being routed to Consumables.
const string VERSION = "2.4.23";
