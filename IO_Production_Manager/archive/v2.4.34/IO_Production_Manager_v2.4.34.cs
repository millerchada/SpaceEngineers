// IO Production Manager v2.4.34 - warehouse sorting, production planning, stall recovery,
...
// v2.4.34: four of the seven recipe-pending products promoted to live recipes. Managed set
// 38 -> 42. Three remain pending on dependency IDENTITIES that do not exist in the repo.
const string VERSION = "2.4.34";
...
void BuildKnowledgeBase() {
  ...
  // MANAGED RECIPE SET - 42 aliases (37 through v2.4.29; ArmoredPlate in v2.4.30; Capacitor,
  // Girder, RadioCommunication and SolarCell in v2.4.34).
  // STILL RECIPE-PENDING, 3: Concrete, Explosives and Canvas. Their recipes are known -
  // Concrete needs Gravel:25, Explosives IronIngot:1 + Gunpowder:4, Canvas SyntheticFabric:10
  // - but Gravel, Gunpowder and SyntheticFabric have NO physical identity anywhere in this
  // repo, and a guessed TypeId/SubtypeId fails SILENTLY: the ingredient never credits, the
  // parent sits permanently Blocked, and nothing says why. Run IO_Item_Identity_Dump on the
  // base to resolve all three, then they can be added with the same one-line change as these.
