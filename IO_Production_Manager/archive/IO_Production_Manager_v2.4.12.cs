// IO Production Manager v2.4.12 - warehouse sorting, production planning, stall recovery,
...
// v2.4.12: 6 new recipes from live in-game tooltips (Superconductor, GravityGenerator,
// Thrust, QuantumComputer, ElectronMatrix, FSSolarCell). Managed set 25 -> 31.
const string VERSION = "2.4.12";
