// IO Production Manager v2.4.24 - warehouse sorting, production planning, stall recovery,
...
// v2.4.24: a SKIPPED phase must not leave its diagnostics reporting the last cycle that ran.
// [IOPM.Organization] froze on stale counters when Organize=false, reading as if it were active.
const string VERSION = "2.4.24";
