// IO Production Manager v2.4.7 - warehouse sorting, production planning, stall recovery,
...
// v2.4.7: BlockedBy is reported whenever it is set, including on a PARTIALLY blocked
// Queued row - the limiting ingredient is exactly what you need there.
