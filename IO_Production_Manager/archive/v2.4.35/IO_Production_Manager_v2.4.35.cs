// IO Production Manager v2.4.35 - warehouse sorting, production planning, stall recovery,
...
// v2.4.35: the last three recipes land. Managed set 42 -> 45, recipe-pending 3 -> 0. The
// blocking dependency identities were resolved live: Gravel, Gunpowder and SyntheticFabric.
const string VERSION = "2.4.35";
...
void BuildKnowledgeBase() {
  ...
  // MANAGED RECIPE SET - 45 aliases. 37 through v2.4.29; ArmoredPlate in v2.4.30; Capacitor,
  // Girder, RadioCommunication and SolarCell in v2.4.34; Concrete, Explosives and Canvas in
  // v2.4.35. THE RECIPE-PENDING SET IS EMPTY: every stock-configurable product can now be
  // manufactured. That does not merge the two ideas - StockConfigurable and _recipes remain
  // independent, and the next product added will be identity-first again.
