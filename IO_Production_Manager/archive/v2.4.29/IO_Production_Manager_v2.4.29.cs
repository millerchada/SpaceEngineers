// IO Production Manager v2.4.29 - warehouse sorting, production planning, stall recovery,
...
// v2.4.29: the [IOPM-Stock] LCD renders the CONFIGURED stock set, not the recipe set - the
// last place a recipe stood in for "is this a stock item". Display only; nothing else changed.
const string VERSION = "2.4.29";
