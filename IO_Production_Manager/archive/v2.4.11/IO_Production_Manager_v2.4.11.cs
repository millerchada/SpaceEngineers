// IO Production Manager v2.4.11 - warehouse sorting, production planning, stall recovery,
...
// v2.4.11: the seeded template groups by the SAME 9 warehouse categories used everywhere
// else, so tools/consumables/bottles get real headings instead of one "Other" heap.
const string VERSION = "2.4.11";
