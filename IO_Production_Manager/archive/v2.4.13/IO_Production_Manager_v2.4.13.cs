// IO Production Manager v2.4.13 - warehouse sorting, production planning, stall recovery,
...
// v2.4.13: DockDiscover is one pass with per-GRID construct caching, so its cost no longer
// multiplies by the number of docked constructs. PERFORMANCE ONLY - no behaviour change.
const string VERSION = "2.4.13";
