// IO Production Manager v2.4.20 - warehouse sorting, production planning, stall recovery,
...
// v2.4.20: a local connector with ThrowOut enabled (an EJECTOR) is never treated as transit
// cargo to recover - throwing material away is the whole point of the block.
const string VERSION = "2.4.20";
