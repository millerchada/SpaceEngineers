// IO Production Manager v2.4.22 - warehouse sorting, production planning, stall recovery,
...
// v2.4.22: REMOTE ejectors are skipped as unload sources too - 2.4.20 only did local ones.
// Connector rules must be applied in BOTH Discover (local) and DockDiscover (remote).
const string VERSION = "2.4.22";
