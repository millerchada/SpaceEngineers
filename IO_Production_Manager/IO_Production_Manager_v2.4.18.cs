// IO Production Manager v2.4.18 - warehouse sorting, production planning, stall recovery,
...
// v2.4.18: loadout quota tables are parsed ONCE per Custom Data change, not every cycle, and
// each container's contents are snapshotted once per cycle. PERFORMANCE ONLY.
const string VERSION = "2.4.18";
