// IO Production Manager v2.4.30 - warehouse sorting, production planning, stall recovery,
...
// v2.4.30: ArmoredPlate gains a live-validated IO 1.7.7 recipe. Managed set 37 -> 38. The
// FIRST of the eight identity-known/recipe-pending products to be promoted. Nothing else moves.
const string VERSION = "2.4.30";
