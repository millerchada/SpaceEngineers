// IO Production Manager v2.4.37 - warehouse sorting, production planning, stall recovery,
...
// v2.4.37: two corrections from the consolidated live IO 1.7.7 evidence - SolarCell takes
// IronIngot:3 not :2, and Gunpowder gains its Munitions Factory recipe. Set 46 -> 47.
const string VERSION = "2.4.37";
...
void BuildKnowledgeBase() {
  ...
  AddRecipes(new string[] {
    ...
    // v2.4.37. Closes the last MANUFACTURED_MISSING_RECIPE leaf. Live-observed on the
    // Munitions Factory at 0.8s. Identity was already known: IO reuses the vanilla
    // MyObjectBuilder_Ingot/Magnesium subtype for the item its UI calls Gunpowder.
    ...
    "Gunpowder|1|Munitions Factory|PotassiumNitrate:6,Carbon:2,Sulfur:2"
  });
}
