// IO Production Manager v2.4.27 - warehouse sorting, production planning, stall recovery,
...
// v2.4.27: [Stock] auto-population is driven by STOCK-CONFIGURABLE IDENTITY, not by recipe
// availability. Existing user values are never read, never overwritten, never deleted.
const string VERSION = "2.4.27";
...
void BuildKnowledgeBase() {
  ...
  // MANAGED RECIPE SET - 37 aliases, UNCHANGED in v2.4.26. A blueprint id does NOT add a recipe
