// IO Production Manager v2.4.33 - warehouse sorting, production planning, stall recovery,
...
// v2.4.33: an alias collision is FAIL-CLOSED at config load - the alias gets NO active quota
// at all, rather than one value silently chosen by dictionary iteration order.
const string VERSION = "2.4.33";
