// IO Production Manager v2.4.36 - warehouse sorting, production planning, stall recovery,
...
// v2.4.36: SyntheticFabric gains a recipe, closing one of two holes found by a recursive
// dependency-closure audit. Gunpowder remains manufactured-but-unimplemented. Set 45 -> 46.
const string VERSION = "2.4.36";
...
void BuildKnowledgeBase() {
  ...
  // MANAGED RECIPE SET - 46 aliases. 37 through v2.4.29; ArmoredPlate in v2.4.30; Capacitor,
