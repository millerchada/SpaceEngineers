// IO Production Manager v2.4.28 - warehouse sorting, production planning, stall recovery,
...
// v2.4.28: the six live-observed manufactured components that were only loadout identities
// become native stock-configurable ItemDefs. Still recipe-less: identity is not production.
const string VERSION = "2.4.28";
