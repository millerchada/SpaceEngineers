// IO Production Manager v2.4.21 - warehouse sorting, production planning, stall recovery,
...
// v2.4.21: a source inventory that moves NOTHING in a full pass backs off for a few cycles,
// so an unreachable one stops re-probing every destination every cycle forever.
const string VERSION = "2.4.21";
