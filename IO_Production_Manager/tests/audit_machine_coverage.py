"""Machine-coverage audit: has IOPM modelled everything the mod actually exposes?
    ...
    python IO_Production_Manager/tests/audit_machine_coverage.py \
...
evidence/machines/*.json - and compares inward.
...
def load_evidence():
    # Evidence is IOPM-specific and lives inside the project, beside the docs generated
    # from it: <project>/evidence/machines/*.json
...
def main():
    ...
    if not machines:
        print('no machine evidence found under evidence/machines/')
        return 2
