// IO Production Manager v2.3.1 — warehouse sorting/balancing/organization,
...
// live under [IOPM.*]. (2.3.1: fixed PB crash in [IOPM-Stock] display —
// sort comparator no longer calls Friendly()/dictionary lookups inline;
// rows are precomputed once with per-row error isolation, matching the
