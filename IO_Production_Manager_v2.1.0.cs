...
//
// v2.1.1: IO process items (e.g. geothermal Heat, SubtypeId="Heat") are now
// excluded from warehouse classification entirely via PROCESS_ITEM_SUBTYPES,
// before generic TypeId category mapping — never routed, never Overflowed,
// never balanced, never cosmetically reordered, never counted, never warned
// about. The owning block itself is untouched; only the item is excluded.
